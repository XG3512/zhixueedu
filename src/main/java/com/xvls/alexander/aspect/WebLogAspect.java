...
import com.xvls.alexander.base.MySysUser;
import com.xvls.alexander.entity.Log;
import com.xvls.alexander.utils.ToolUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.xvls.alexander.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.xvls.alexander.annotation.SysLog mylog = method.getAnnotation(com.xvls.alexander.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
        ...
        if(MySysUser.ShiroUser() != null) {
            sysLog.setUsername(StringUtils.isNotBlank(MySysUser.nickName()) ? MySysUser.nickName() : MySysUser.loginNum());
        }
    }
